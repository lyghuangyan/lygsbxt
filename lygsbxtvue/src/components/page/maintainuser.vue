    ...
    <div class="table">
        <div class="container">
            <div class="handle-box">
                <el-button type="primary" icon="delete" class="handle-del mr10" @click="addMaintainuser">新增</el-button>
            ...
            <el-table :data="tableData" border style="width: 100%">
                ...
                <el-table-column label="操作" min-width="241">
                    <template slot-scope="scope">
						...
						@click="handleEdit(
						scope.row.maintainid, scope.row.username, 
						scope.row.realname, scope.row.photourl, 
						scope.row.remark)">
						编辑</el-button>
						<el-button size="small" 
						@click="handleResetPassword(scope.row.maintainid)">
						重置密码</el-button>
                        <el-button size="small" type="danger" 
						@click="handleDelete(scope.row.maintainid)">
						删除</el-button>
    ...
    export default {
        data() {
            return {
				...
				isMultiple: true,
				imgLimit: 1,
                url: this.GLOBAL.proName+'/maintainuser/pageMaintainuser',
                tableData: [],
                cur_page: 1,
                multipleSelection: [],
                select_cate: '',
        ...
        methods: {
            ...
            getData() {
                ...
                this.axios.get(
				that.GLOBAL.proName+'/maintainuser/pageMaintainuser?size=10&page='
            ...
            handleEdit(maintainid, username, realname, photourl, remark) {
				this.form.maintainid = maintainid;
